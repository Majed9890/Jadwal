...
const { createEvent, getOrganizerEvents, getOrganizerDashboard, searchEvents, filterEvents, getEventStats, getEventGenderStats } = require('../controllers/eventController');
