...
const { editProfile, updateInterests, likeEvent, getProfile, checkLike, logEventView } = require('../controllers/attendeeController');
...
router.post('/event-view', verifyToken, logEventView);
